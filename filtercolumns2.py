...
data=pd.read_csv('/data/salomonis2/NCI-R01/TCGA-BREAST-CANCER/Anukana/UO1analysis/tcga_rsem_gene_tpm.txt', sep='\t', index_col=1)
print data.head()
...
#print data.shape
data.to_csv('/data/salomonis2/NCI-R01/TCGA-BREAST-CANCER/Anukana/UO1analysis/tcga_rsem_gene_tpm_filtered.txt', sep='\t')
